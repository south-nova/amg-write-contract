  ...
  return (
    <div className="overflow-y-auto p-6">
      <p className="mb-10">
        ...
        <span className="text-primary"> {name}</span> (이하 “乙”이라 한다)은(는) 다음과 같이 용역 계약을
        체결하고 상호 성실히 준수할 것을 약정한다.
      </p>

      <section className="mb-7">
        <h2 className="mb-2 font-bold">제1조 (계약의 목적)</h2>
        <p>
          본 계약은 乙이
      ...
      <section className="mb-7">
        <h2 className="mb-2 font-bold">제2조 (용역범위 및 성실의무)</h2>
        <p>
          甲은 乙에게 甲의{' '}
      ...
      <section className="mb-7">
        ...
        <p>
          ...
          행사 현장이 종료되는 경우 본 계약 또한 종료되는 것으로 한다.
        </p>
      </section>
      ...
      <section className="mb-7">
        ...
        <ul className="flex flex-col gap-3 pl-1">
          ...
          <li>
            <span className="mr-2">②</span>
            乙의 용역업무 수행을 위한 장소 및 시간은 업무에 지장이 없는 범위 내에서 甲의 사정을 고려하여 乙과
            사전 협의하여 정하기 로 하며, 乙은 甲의 업무상 필요와 乙의 업무상 편의를 위해 甲이 제공한 장소에서
            용역 업무를 수행할 수 있다. 이 경우 乙은 甲 이 정한 입·퇴실 시간 등의 시설관리방침을 준수하여야
            한다.
          </li>
          <li>
            <span className="mr-2">③</span>
            乙은 원칙적으로 용역 업무에 필요한 기계·기구, 제품, 설비 등을 자신의 비용으로 구입하여 사용하여야
            한다. 다만 甲은 乙이 작업하는데 필요 한 장소 및 자료, 도구 등의 제반 수단을 무상으로 제공할 수
            있으며, 이는 乙의 원활한 업무 수행을 위한 편의 제공이라는 목적을 지닌다.
          </li>
          <li>
            <span className="mr-2">④</span>
            乙은 甲이 제공한 장소 및 자료, 도구 등을 본건 작업 이외에는 사용할 수 없으며, 선량한 관리자로서의
            주의의무를 다하여 사용 하여야 한다.
          </li>
        </ul>
      </section>
      ...
      <section className="mb-7">
        <h2 className="mb-2 font-bold">제5조 (용역 수수료)</h2>
        <ul className="flex flex-col gap-3 pl-1">
          <li>
            <span className="mr-2">①</span>
          ...
          <li>
            <span className="mr-2">②</span>
            乙은 소득세법 제127조의 규정에 의해 제1항의 수수료에 대한 제세공과금을 부담하며, 甲은 수수료 지급
            시 3.3%(주민세 포함) 의 원천징수액을 차감한 다음 지급한다.
          </li>
        </ul>
      </section>

      <section className="mb-7">
        <h2 className="mb-2 font-bold">제6조 (계약의 해지)</h2>
        <h3 className="mb-2">甲과 乙은 다음 각 호의 사유가 발생하였을 경우 본 계약을 해지할 수 있다.</h3>
        <div className="pl-1">
          ...
          <p>
            6. 乙이 사업장 내 다른 동업자들과 불화를 일으켜 다른 동업자의 계약해지를 유발하거나 이를 방지하기
            위한 甲의 권고를 의도적 으로 무시하여 甲의 정상적인 행사 진행 활동 및 고객서비스가 원활하게
            이루어지는 것을 방해하는 경우
          </p>
          <p>
            7. 기타 甲의 경영상 사정 또는 乙의 귀책사유 등 기타의 사정으로 乙과의 계약 관계를 계속 유지할 수
            없다고 판단되는 경우
          </p>
        </div>
      </section>
      ...
      <section className="mb-7">
        <h2 className="mb-2 font-bold">제7조 (배상책임)</h2>
        <h3 className="mb-2">
          乙이 다음 각호의 사유로 甲에게 손해를 발생케 한 경우 甲은 이에 대한 배상을 청구할 수 있다.
        </h3>
      ...
      <section className="mb-10">
        <h2 className="mb-2 font-bold">제8조 (기타사항)</h2>
        <ul className="flex flex-col gap-3 pl-1">
          <li>
            <span className="mr-2">①</span>본 계약에 명기하지 아니한 사항 및 본 계약에 해석상의 이의가 있을
            때는 甲과 乙 쌍방의 협의에 따라 결정한다. 다만, 협의가 원만하지 않을 경우 甲의 해석에 따른다.
          </li>
