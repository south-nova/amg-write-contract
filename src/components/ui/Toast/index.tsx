...
>(({ className, variant = 'default', duration = 3000, children, ...props }, ref) => {
  return (
    <ToastPrimitives.Root
      ...
      {...props}
    >
      <div className="mr-6 inline-flex h-9 w-9 items-center justify-center rounded-full bg-white">
